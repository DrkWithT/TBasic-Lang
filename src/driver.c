...
static const LexItem special_lexicals_v[] = {
    ...
    (LexItem) {.literal = "THROW", .tag = tk_keyword_throw},
    (LexItem) {.literal = "TRY", .tag = tk_keyword_try},
    ...
    (LexItem) {.literal = "~", .tag = tk_os_bit_not},
    ...
    (LexItem) {.literal = "&", .tag = tk_os_bit_and},
    (LexItem) {.literal = "|", .tag = tk_os_bit_or},
    (LexItem) {.literal = "^", .tag = tk_os_bit_xor},
    (LexItem) {.literal = "<<", .tag = tk_os_bit_shl},
    (LexItem) {.literal = ">>", .tag = tk_os_bit_shr},
