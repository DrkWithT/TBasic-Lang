...
VMStatus fn_bit_not(VMState *, const Instruction *, const Value *, Value *);
...
VMStatus fn_bit_and(VMState *, const Instruction *, const Value *, Value *);
VMStatus fn_bit_or(VMState *, const Instruction *, const Value *, Value *);
VMStatus fn_bit_xor(VMState *, const Instruction *, const Value *, Value *);
VMStatus fn_bit_shl(VMState *, const Instruction *, const Value *, Value *);
VMStatus fn_bit_shr(VMState *, const Instruction *, const Value *, Value *);
